...
def start_driver():
    desired_caps = {
        ...
        'app': 'C:/Users/TLS/Desktop/New folder/New folder/TLH_dev_20241226_1.0.apk',  # path to your app
...
def perform_action(driver):
    try:
        ...
        enterID.send_keys('1187732671')  # Click the second button
        print("inserting id")
        ...
        registernow=driver.find_element(By.XPATH,'/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ScrollView/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.view.ViewGroup[1]/android.widget.LinearLayout/android.widget.RelativeLayout')
        registernow.click()
        ...
        #
        driver.implicitly_wait(40)
        Selectdate=driver.find_element(By.XPATH,'//android.view.View[@content-desc="01 December 2004"]')
        Selectdate.click()
        print("select year  01 December 2004 ")
        ...
        EmailAddress.send_keys("Zubair64503@mailinator.com")
        print("EmailAddress")
        driver.implicitly_wait(40)
